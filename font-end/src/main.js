...
import dentifyView from "./components/Identify/dentifyView.vue";
import dentify from "./components/Identify/dentify.vue";
app.use(ArcoVue);
...
app.component('dentify',dentify);
app.component('dentifyView',dentifyView)
